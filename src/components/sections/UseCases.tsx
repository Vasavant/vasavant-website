...
export async function UseCases() {
  ...
  return (
    <section id="use-cases" className="section-cream-alt section-pad relative overflow-hidden">
      <DoodleDecor
        variant="dots"
        className="absolute top-24 right-[6%] w-12 h-12 text-[var(--cta)] opacity-25 hidden lg:block"
      />
      <DoodleDecor
        variant="squiggle"
        className="absolute bottom-32 left-[4%] w-14 h-10 text-[var(--ink)] opacity-20 hidden md:block"
      />
